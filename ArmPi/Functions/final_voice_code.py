        ...
        while True:
            ...
            if self.perception.current_detected_color != "None":
                ...
                if move_result:
                    ...
                    # STEP 13: Reset status for next block
        ...
        while True:
            ...
            if recognizer.AcceptWaveform(data_bytes):
                ...
                if activation_phrase in recognized_text:
                    print("Activation phrase recognized. Starting motion system.")
                    break

if __name__ == "__main__":
    # First, wait for the activation phrase
    wait_for_activation_phrase("time to go eat")
    
    # Once the phrase is detected, initialize the perception and motion systems
    perception_system = Perception()
    motion_system = Motion(perception_system)
    
    # Create separate threads for perception and arm control
